 ...
 */
 ...
 const App = () => {
   ...
   const createColorFinder = () => {
     if (filePath.uri) {
       if (Platform.OS === 'android') {
         ...
         ImageColorPick.getRGBArray(filePath.uri.replace('file:', ''),layout.width, layout.height)
         .then(rgbArray => {
         ...
         let JsonObject = {"filePath":filePath.uri.replace("file:",""),"width":layout.width,"height":layout.height}
           ImageColorPick.getRGBArray(JsonObject,(err,rgbArray) => {
            const colorFinder = ColorFinder.fromRGBArray(rgbArray);
            setColorFinder(colorFinder);
            const mainColors = colorFinder.mainColors();
            console.log(mainColors)
   ...
   const getColor = (e,index) => {
     if (colorFinder !== null && colorFinder !== undefined) {
       const x = e.nativeEvent.locationX;
       const y = e.nativeEvent.locationY;
       setColor(colorFinder.colorAtPos(x, y, layout));
       console.log("position>>>>>>>>>>"+index);
       console.log("position>>>>>>>>>>"+colorFinder.colorAtPos(x, y, layout));
       primaryColors[index] = colorFinder.colorAtPos(x, y, layout);
         ...
         <Image
           ...
           {primaryColors.map((item, index) => {
               ...
               console.log(`x: ${result["x"]}, y: ${result["y"]}`)
                ...
                //        isCircle  
                //        onDragRelease={e => getColor(e,index)} />
                //      <Draggable/>
                //    </View> 
                //  )
               }
